...
function CompletedModal({ openModal, setOpenModal }) {
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-50 px-4">
            ...
            <div className="w-full max-w-[30rem] bg-[#eaf4f4] rounded-2xl px-6 py-8 shadow-2xl text-center">
                ...
                <p className="text-[#0e9995] text-base">
                    You have successfully created a group. Please wait for confirmation for the students you requested to add.
                </p>
